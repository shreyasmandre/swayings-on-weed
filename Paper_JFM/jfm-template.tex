...
\shorttitle{Guidelines for authors} %for header on odd pages
\shortauthor{A. N. Other et al} %for header on even pages
...
\begin{table}
 \begin{center}
  ...
  \end{tabular}
  \caption{Values of $kd$ at which trapped modes occur when $\rho(\theta)=a$}{\label{tab:kd}}
 \end{center}
\end{table}
