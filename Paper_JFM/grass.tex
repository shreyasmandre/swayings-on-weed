...
\begin{figure}
\centerline{\includegraphics[scale=0.95]{Grass_Base_Nepf_shear} \includegraphics[scale=0.95]{Grass_shear_scale}}
...
All experimental data we have found corresponds to a vegetation density for which the unstable region in the $\Rey-k$ space has not split into two, so we are unable to say if flow instability in the lab scale experiments \citep{Ghisal02} are due to Mode1 or Mode2.
