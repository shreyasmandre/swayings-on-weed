...
The threshold flow condition arises from a competition between of the destabilizing role of fluid inertia, which is very similar to the one played in KH, and the vegetation drag.
...
In this limit, the non-dimensional flow in the grass bed is $U_g/U_0 \sim (\Rey \Ndg)^{-1/2} \ll 1$, and therefore $ikU \approx \sigma$ may be neglected in comparison to $\sigma$. 
