...
\label{navier-stokes}
\end{equation}
where $\rho$, $\bu$, and $p$ are the fluid density, velocity, and the dynamic pressure respectively, and is $\mu$ the dynamic eddy viscosity. % and $\mathbf{g}$ the acceleration due to gravity. 
