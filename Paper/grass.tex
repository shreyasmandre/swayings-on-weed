...
We are left with three non-dimensional parameters in the model, viz. the Reynolds number $R= {\rho U_0 H}/{\mu}$, the vegetation drag parametrized as $\delta/H$, 
and the submergence ratio of the grass $h_g/H$. With these scaling, and using a stream function $\psi$ with $u = \psi_{y}, v= -\psi_x$ to satisfy mass balance, we seek a wave solution of the form $\left(u,v,\psi \right)= \left(\hat u, \hat v, \hat\phi \right)e^{ikx+\sigma t}$ to  obtain a modified Orr-Sommerfield equation. 
...
\subfigure[]{\includegraphics[scale = 0.72]{Set4_dens28_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set4_dens30_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set4_dens32_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set4_dens34_imgsc}}

\subfigure[]{\includegraphics[scale = 0.72]{Set5_dens38_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set5_dens40_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set5_dens42_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set5_dens46_imgsc}}

\subfigure[]{\includegraphics[scale = 0.72]{Set6_dens32_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set6_dens34_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set6_dens36_imgsc}}
\subfigure[]{\includegraphics[scale = 0.72]{Set6_dens38_imgsc}}
