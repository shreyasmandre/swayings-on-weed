...
We study the mechanism behind Mo-nami, a phenomenon associated with the synchronous waving of marine grass. Linear stability analysis of a mathematical model incorporating grass drag as a continuum field has been 
...
One of these mode has many characteristics similar to the Kelvin-Helmholtz instability where shear layer formed near grass tip due to grass drag discontinuity plays a critical role, we termed this as ``Mode 1''. 
The other mode can be interpreted as instability of 
inviscid flow through a grass bed where shear layer doesn't play an important role, we refer this as ``Mode 2''. In the limit of dense grass bed these two modes can be
