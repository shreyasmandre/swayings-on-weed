...
We show that a linear instability of a steady pressure-driven flow explains the experimentally observed flow threshold for waving and the waving frequency, confirming the hydrodynamic mechanism for the onset of waving, where the vegetation flexibility merely serves to visualize the flow.
We also demonstrate that flow instability mechanism leading to waving is different from the Kelvin-Helmholtz instability.
\end{abstract}
