...
One of these mode has many characteristics similar to the Kelvin-Helmholtz instability where shear layer formed near grass tip due to drag discontinuity plays a critical role, we termed this as ``Mode 1''. 
