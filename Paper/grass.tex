...
This model has been applied successfully to predict the the observed frequency of \monami~\cite{Ghisal02} and to understand transport in the seagrass bed.
\newline
...
\end{align}
\begin{figure}
\includegraphics[width=15cm]{Asymptotic_noshear}
