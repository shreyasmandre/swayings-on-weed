...
thickness $\delta = \epsilon^{1/3} H$, where $\epsilon = \left[({\rho U_0 H}/\mu) (C_N d N_g H)\right]$, $U_0 = {(dP/dx)~H^2}/{\mu}$ is scale for velocity, and
$H$ is half channel width. The dependence of the boundary layer thickness on the grass density $N_g$ gives us a way to systematically control it and investigate its effect on the instability mechanism. 
\begin{figure}[htb]
