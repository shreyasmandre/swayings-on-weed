...
\geometry{headheight = 0.7in,tmargin=1in}
\fancypagestyle{firstpage}{\fancyhf{}\fancyhead[L]{\includegraphics[height=0.9in, keepaspectratio=true]{logo}}}
\fancypagestyle{plain}{\fancyhf{}\fancyhead[L]{\includegraphics[height=0.9in, keepaspectratio=true]{logo}}}
\pagestyle{plain}
